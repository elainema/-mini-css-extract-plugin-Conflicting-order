<template>
    <div class="filter-offer_id chosen-filter nopadding col-xs-12" ref="filter_offer">
        ...
        <input v-if="placeholder" :data-name="data_name" :name="select2_name" type="hidden" :class="select2_class" class=" nopadding  col-xs-12"  ref="select2" :placeholder="data_placeholder" v-model='offer_id'/>
        <input v-else :data-name="data_name" :name="select2_name" type="hidden" :class="select2_class" class=" nopadding  col-xs-12"  ref="select2" v-model='offer_id'/>
