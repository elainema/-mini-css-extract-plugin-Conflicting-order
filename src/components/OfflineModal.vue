    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group row mt20 mb20">
            ...
            <div class="col-md-9">
                <input id="offline_input" class="form-control" type="text" value="" maxlength="255">
            </div>
        </div>
      </div>
      <div class="modal-footer">
        <button class="btn btn-primary offline_confirm" @click.prevent="hideModal">Confirm</button>
