<template>
   <div class="">
        <select style="float:left;width:280px" size="5" multiple="multiple" id="off_white_list" v-model="editVal">
...
<script>
import createOfferWhiteIPModal from './OfferWhiteIPModal.vue'
...
export default{
    ...
    components: {createOfferWhiteIPModal },
    methods: {
        rebackBtn(new_ip) {
