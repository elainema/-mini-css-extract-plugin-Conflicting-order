        ...
        <div class="box">
            ...
            <div class="box-container">
                ...
                <div class="box-content">
                    <form ref="filterForm">
                        <filter_form :currentPage="currentPage" :pageLimit="pageLimit" :list_offers="list_offers" :renderFilter="renderFilter" :groupChosen="groupChosen"  :renderCallback="renderCallback" :showAlert="showAlert" :sort_by_group="sortFilter.group_id"></filter_form>
                    </form>
...
<script>
    import filter_form from '@/components/Offer_Group_Filter_Form.vue'
    ...
    export default {
        ...
        components: {
            filter_form,pagination,AlertPop,Modal
        },
        watch:{
            selected_id() {
