        ...
        <div class="box">
            ...
            <div class="box-container">
                ...
                <div class="box-content">
                    <form ref="filterForm">
                        <filter_form :currentPage="currentPage" :pageLimit="pageLimit" :list_offers="list_offers" :renderFilter="renderFilter" :advChosen="advChosen" :catChosen="catChosen" :geoChosen="geoChosen" :amChosen="amChosen" :platChosen="platChosen" :trafficChosen="trafficChosen" :renderCallback="renderCallback" :showModal="showModal" :showAlert="showAlert" :product_remove_offer="product_remove_offer" :sort_by_advertiser="sortFilter.advertiser" :sort_by_category="sortFilter.category" :sort_by_country="sortFilter.country" :sort_by_device="sortFilter.device" :sort_by_traffic="sortFilter.traffic"></filter_form>
                    </form>
...
/*const batchAffiliateCaps = () => import(
 webpackChunkName: "batchAffiliateCaps"  '../components/batch-affiliate-caps/'
);*/
const BatchAffiliateCaps = () => import(
...
export default {
    ...
    components: {
        filter_form,pagination,AlertPop,ChangeOfferStatusModal,PayoutRevenueReserveModal,OfferRecommendModal,BatchAffAccessModal,BatchPublisherAppModal, UpdateOfferLogoModal,AddProductOfferDailog,BatchAffiliateCaps,BatchAppCaps,AddRotateGroupModal
    },
    watch:{
        selected_id() {
