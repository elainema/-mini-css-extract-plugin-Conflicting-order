...
<div :class="loadingZone ? 'ajax_loading' : '' ">
            ...
            <form class="form-horizontal frm-entity" id="cc_add" ref="cc_add" @submit.stop.prevent="submitForm">
                ...
                <div class="box-content">
                    ...
                    <div class="control-group form-group field-required">
                        ...
                        <div class="controls">
                            <dateTimePicker :startDate="calcu_expiration_date()" :name="'expiration_date'" :date="expiration_date"></dateTimePicker>
                        </div>
                    </div>
                    <div class="control-group form-group field-required">
                    ...
                    <div class="control-group form-group field-required">
                        ...
                        <div class="controls">
                            <!-- <create_switch :yes_text="'Private'" :no_text="'Public'" id="is_private" :name="'is_private'" :offer_val="is_private" :switchCallBack="switchCallBack"></create_switch> -->
                            <common-switch
                                id="is_private"
                                :updateState="false"
                    ...
                    <div :class="'control-group form-group ' +　(is_private == 1 ? 'hide': '')" id="require_approval_div">
                        ...
                        <div class="controls">
                           <!--  <create_switch id="is_require_approval" :name="'is_require_approval'" :offer_val="is_require_approval" :switchCallBack="switchCallBack"></create_switch> -->
                            <common-switch
                    ...
                    <div class="control-group form-group field-required">
                        ...
                        <div class="controls a1  col-md-10 nopadding" data-base="a">
                            <allowedTraffic :type="offer_type" :defaulVal="traffic_ids" :from="from" :renderOffer="sourceTraffics" :source="sourceTraffics"></allowedTraffic>
                        </div>
                    </div>
                    <div class="control-group form-group field-required">
                        <label class="control-label col-md-2" for="is_exclusive">Exclusive<i class="icon-exclamation red"></i></label>
                        <div class="controls">
                           <!--  <create_switch id="is_exclusive" :name="'is_exclusive'" :offer_val="is_exclusive" :switchCallBack="switchCallBack"></create_switch> -->
                            <common-switch
                                id="is_exclusive"
                                :updateState="false"
                    ...
                    <div class="control-group form-group field-required">
                        ...
                        <div class="controls">
                           <!--  <create_switch id="is_incentive" :name="'is_incentive'" :offer_val="is_incentive" :switchCallBack="switchCallBack"></create_switch> -->
                            <common-switch
                                id="is_incentive"
                                :updateState="false"
               ...
               <div class="box-content" id="payment">
                   ...
                   <div class="control-group form-group field-required">
                       ...
                       <div class="controls">
                            <!-- <create_switch id="is_dynamic_revenue" :name="'is_dynamic_revenue'" :offer_val="is_dynamic_revenue" :switchCallBack="switchCallBack"></create_switch> -->
                            <common-switch
               ...
               <div class="box-content" v-show="offer_type != 'cps'" id="caps_content">
                   <div class="control-group form-group">
                       ...
                       <div class="controls">
                            <!-- <create_switch id="is_caps" :name="'is_caps'" :offer_val="is_caps" :switchCallBack="switchCallBack"></create_switch> -->
                            <common-switch
                                id="is_caps"
                                :updateState="false"
                                :default_val="is_caps"
               ...
               <div class="box-content hide box-content-country">
                   ...
                   <div class="control-group form-group">
                       ...
                       <div class="controls">
                            <!-- <create_switch id="is_geo_targeting_top" :name="'is_geo_targeting'"  :offer_val="is_geo_targeting"  :switchCallBack="switchCallBack" :switch_disable="is_enforce_geo_targeting"  :setOffWhenDisabled="1" ></create_switch> -->
                            <common-switch
                   ...
                   <div class="control-group form-group">
                       ...
                       <div class="controls">
                            <!-- <create_switch id="is_device_targeting_top"  :name="'is_device_targeting'"  :offer_val="is_device_targeting" :switchCallBack="switchCallBack" :switch_disable="is_enforce_device_targeting"  :setOffWhenDisabled="1"></create_switch> -->
                            <common-switch
    ...
    <virusScanningModal :modalState="virusScanningModal" :hideModal="hideModal" :riskRate="risk_rate" :setTrackingDomain="set_tracking_domain"></virusScanningModal>
...
import allowedTraffic from '@/components/AllowedTraffic.vue'
...
//import create_switch from '@/components/common/switch/'
