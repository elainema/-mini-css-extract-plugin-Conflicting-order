        ...
        <div class="box-container">
            <div class="box-content form-horizontal frm-entity frm-detail">
                ...
                <div class="control-group form-group">
                    ...
                    <div class="controls">
                        <!-- <switch_offer :offer_param='"is_geo_targeting"' :offer_val="offerInfo.is_geo_targeting" :showAlert='showAlert' :renderOffer="renderOffer" :switchCallBack="switchCallBack" :switch_disable="country" :setOffWhenDisabled="1" ></switch_offer> -->
                        <common-switch 
                            :showAlert='showAlert'
                ...
                <div class="control-group form-group">
                    ...
                    <div class="controls">
                       <!--  <switch_offer :offer_param='"is_device_targeting"' :offer_val="offerInfo.is_device_targeting" :showAlert='showAlert' :renderOffer="renderOffer" :switchCallBack="switchCallBack" :switch_disable="device_names" :setOffWhenDisabled="1"></switch_offer> -->
                        <common-switch 
                            :showAlert='showAlert'
                            :updateInfo="updateOfferInfo"
                ...
                <div class="control-group form-group">
                    ...
                    <div class="controls">
                        <!-- <switch_offer :offer_param='"is_device_os_targeting"' :offer_val="offerInfo.is_device_os_targeting" :showAlert='showAlert' :renderOffer="renderOffer" :switchCallBack="switchCallBack" :switch_disable="device_os" :setOffWhenDisabled="1" ></switch_offer> -->
                        <common-switch 
                            :showAlert='showAlert'
                            :updateInfo="updateOfferInfo"
                ...
                <div class="control-group form-group">
                    ...
                    <div class="controls">
                        <!-- <switch_offer :offer_param='"is_device_model_targeting"' :offer_val="offerInfo.is_device_model_targeting" :showAlert='showAlert' :renderOffer="renderOffer" :switchCallBack="switchCallBack"  :switch_disable="device_model" :setOffWhenDisabled="1" ></switch_offer> -->
                        <common-switch 
                            :showAlert='showAlert'
                            :updateInfo="updateOfferInfo"
                ...
                <div class="control-group form-group">
                    ...
                    <div class="controls">
                        <!-- <switch_offer :offer_param='"is_carriers_targeting"' :offer_val="offerInfo.is_carriers_targeting" :showAlert='showAlert' :renderOffer="renderOffer"  :switch_disable="carriers_target" :setOffWhenDisabled="1" ></switch_offer> -->
                        <common-switch 
                            :showAlert='showAlert'
                            :updateInfo="updateOfferInfo"
