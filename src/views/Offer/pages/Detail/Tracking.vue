        ...
        <div class="box-container">
            <div class="box-content form-horizontal frm-entity frm-detail">
                ...
                <div class="control-group form-group" id="globalTypeShowWithAff"  v-show="aff_id != ''">
                    ...
                    <div class="controls col-md-10 nomargin nopadding">
                        <!-- <switch_offer :offer_param='"use_advanced_pixel"' :getCustomParam="getCustomParamPixel" :yes_text="'Advanced'" :no_text="'Simple'" :offer_val="is_use_advanced_pixel" :showAlert='showAlert' :renderOffer="renderOffer" :switchCallBack="switchCallBack" :switchDefaultAPI="setUseAdvancedPixel" :aff_id="aff_id"></switch_offer> -->
                        <common-switch
                            :showAlert='showAlert'
...
export default {
    ...
    components: { AdvancedGlobalPixel, editable_text_offer, offerConversionWhiteList, EditableTextareaOffer,HelpBox,CommonSwitch },
    methods: {
        customParam() {
            var query = {}
