...
<div v-yeah-loading='loadingZone'>
        ...
        <div class="box-container">
            <div class="box-content form-horizontal frm-entity frm-detail">
                ...
                <div class="control-group form-group">
                    ...
                    <!-- <switch_offer :offer_param='"is_dynamic_revenue"' :onSuccess="onDynamicSwitchSuccess" :offer_val="offerInfo.is_dynamic_revenue" :showAlert='showAlert' :renderOffer="renderOffer" :offer_type="offer_type" :switchDefaultAPI="'Offer2/setTask'" :switchGetCustomParam="getCustomParamNoDynamicRevenue"  :offer_hide_conv="offerInfo.hide_conv"></switch_offer> -->
                    <common-switch 
                        :showAlert='showAlert'
    ...
    <change-offer-payout-revenue-modal
...
export default {
    ...
    components: { editable_select2_redirect_offer, editable_select2_payout_redirect_offer,mutiplle_events, editable_text_offer, editable_caps_offer, ChangeOfferPayoutRevenueModal,HelpBox,CommonSwitch,paymentDialog},
    watch:{
