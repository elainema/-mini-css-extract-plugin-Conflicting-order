...
<div v-yeah-loading='loadingZone'>
        ...
        <div class="box-container" ref="basic_wrapper">
            <div class="box-content form-horizontal frm-entity frm-detail">
                ...
                <div class="control-group form-group">
                    ...
                    <div class="controls col-md-10 nomargin nopadding">
                        <!-- <switch_offer :offer_param='"use_advanced_pixel"'  :yes_text="'Advanced'" :no_text="'Simple'"  :offer_val="offerInfo.use_advanced_pixel" :showAlert='showAlert' :renderOffer="renderOffer"></switch_offer> -->
                ...
                <div class="control-group form-group">
                    ...
                    <!-- <switch_offer :offer_param='"is_private"' :offer_val="offerInfo.is_private" :yes_text="'Private'" :no_text="'Public'" :showAlert='showAlert' :renderOffer="renderOffer"  :onSuccess="onPrivateSwitchSuccess" :switchCallBack="switchCallBack_permission"></switch_offer> -->
                    <common-switch
                        :showAlert='showAlert'
                        :updateInfo="updateOfferInfo"
                ...
                <div class="control-group form-group" v-show="offerInfo.is_private != 1">
                   ...
                   <!--  <switch_offer :offer_param='"is_require_approval"' :offer_val="offerInfo.is_require_approval" :showAlert='showAlert' :renderOffer="renderOffer" :switchCallBack="switchCallBack" :showModal="showModal"></switch_offer> -->
                ...
                <div class="control-group form-group">
                    ...
                    <!-- <switch_offer :offer_param='"is_exclusive"' :offer_val="offerInfo.is_exclusive"  :showAlert='showAlert' :renderOffer="renderOffer"></switch_offer> -->
                    <common-switch
                        :showAlert='showAlert'
                        :updateInfo="updateOfferInfo"
                ...
                <div class="control-group form-group">
                    ...
                    <!-- <switch_offer :offer_param='"is_incentive"' :offer_val="offerInfo.is_incentive" :showAlert='showAlert' :renderOffer="renderOffer"></switch_offer> -->
                    <common-switch
                        :showAlert='showAlert'
                        :updateInfo="updateOfferInfo"
                ...
                <div class="control-group form-group">
                    <label class="control-label col-md-2"><a href="javascript:;">Quality Rating</a></label>
                        <!-- <switch_offer :offer_param='"is_quality"' :offer_val="ocpaData.is_quality_rating" :showAlert="showAlert" :renderOffer="renderOffer" :switchDefaultAPI="'Ocpa/setOfferQuality'" :getCustomParam="getCustomParamOfferQuality" ></switch_offer> -->
                        <common-switch
                            :showAlert='showAlert'
                            :updateInfo="updateOfferInfo"
                ...
                <div class="control-group form-group">
                    <label class="control-label col-md-2"><a href="javascript:;">Fraud Traffic Allowed</a></label>
                        <!-- <switch_offer :offer_param='"is_fraud_allowed"' :offer_val="ocpaData.is_fraud_allowed" :showAlert="showAlert" :renderOffer="renderOffer" :switchDefaultAPI="'Ocpa/setOfferQuality'" :getCustomParam="getCustomParamOfferQuality"></switch_offer> -->
                        <common-switch
                            :showAlert='showAlert'
                            :updateInfo="updateOfferInfo"
    ...
    <add-token-modal :modalStateAddTokenModal.sync="modalState_addTokenModal" :tokenList="tokenList" :conversion_pixel="conversion_pixel" :dialogName="'modalStateAddTokenModal'" :showPrompt="showPrompt"></add-token-modal>
...
//import switch_offer from '@/components/Switch_Offer.vue'
...
export default {
    ...
    components: {CommonSwitch, ApplicationQuestions, ckeditor, editable_select2_offer,EditableTextareaOffer,editable_text_offer,editable_date_offer,confirmModal, AddTokenModal, AdvancedGlobalPixel, chosen_container_offer, editable_checkbox_offer,HelpBox,ConfirmPermissionModal,ConfirmApproveModal,EditableTextPreview},
    computed:{
